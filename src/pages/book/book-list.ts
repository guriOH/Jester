...
//page : ShowListPage
import { BookPayPage } from '../book/book-pay';
import { BookInfPage } from '../book/book-inf';


import { SearchAddressPage } from '../map/search-address';

@Component({
    selector: 'pages-book-list',
...
export class BookListPage {
    ...
    getArtListInfo() {
        ...
        this.jsonpService.getDefaultAPI('8002', data).subscribe(
            data => {

                if (data != null) {
                    this.items = this.aaa(data);
                    this.itemsInfo = data;
    ...
    showlist(param) {
        ...
        this.navCtrl.push(BookPayPage, param);
    ...
    _createEventBuy() {
        this.events.subscribe('event:artbook', () => {
